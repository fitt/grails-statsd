...
public class StatsdClientImpl implements StatsdClient {
    ...
    private static Logger log = Logger.getLogger(StatsdClientImpl.class.getName());
    ...
    public StatsdClientImpl(InetAddress host, int port) throws IOException {
